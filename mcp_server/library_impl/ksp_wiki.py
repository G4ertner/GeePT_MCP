...
def search_ksp_wiki_impl(query: str, limit: int = 10) -> str:
    """
...
def get_ksp_wiki_page_impl(title: str, max_chars: int = 5000) -> str:
    """
...
def get_ksp_wiki_section_impl(title: str, heading: str, max_chars: int = 3000) -> str:
    """
